...
class Car_():
    ...
    def update(self, keys, screen, enemys, map, check_points, under_ways,snow,console:Console,map_pick):
        ...
        if self.type != 0:
            ...
            if self.type == 5 and enemys[self.agro_target].lap != self.laps-1:
                self.check_agro(enemys[self.agro_target],check_points)
            else:
                self.agro2=0
    ...
    def check_agro(self, player,checkpoints):
        if player.lap > self.lap:
            ...
            print(checkpoints.len,player.check_point,self.check_point)
            if checkpoints.len-player.check_point+self.check_point<=2:
                self.agro2=2
            else:
                self.agro2 = 3
